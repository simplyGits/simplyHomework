...
Picker.route '/m/:muid/f/:fid', (params, req, res) ->
	err = (code, str) ->
		res.writeHead code, 'Content-Type': 'text/plain'
		res.end str
	...
	file = _.find message.attachments, _id: params.fid
	unless file?
		err 404, 'file not found'
		return undefined
	...
	trackFileDownload
		messageId: params.muid
		fileId: params.fid
	undefined

Picker.route '/ci/:ciid/f/:fid', (params, req, res) ->
	err = (code, str) ->
		res.writeHead code, 'Content-Type': 'text/plain'
		res.end str
	...
	calendarItem = CalendarItems.findOne
		...
		userIds: userId
	unless calendarItem?
		err 404, 'calendarItem not found'
		return undefined

	file = _.find calendarItem.files, _id: params.fid
	unless file?
		err 404, 'file not found'
		return undefined
